 ...
 * 
 * The formula for the Fourier Series / Wave Equation is the following (this is the terms the
 * coefficients correspond to):
 * 		Summation from n = 1 to infinity [c_n * sin(n*PI*x/L) * cos(n*PI*beta*t/L)].
 ...
 * 
 */
public class GraphWave implements Graph {
	...
	public GraphWave(List<Double> coefficients, float beta, float deltaX, float L) {
