...
/**
 * @author Mariu
 * Simulate the heat equation. There are two different ways to do it in this class:
 ...
 * solution of the heat equation. This Graph object can then be passed onto the Drawer
 ...
 */
public class HeatSimulation implements Simulation {
	...
	/**
	 * The thermal diffusivity of the element the heat is passing through.
	 */
	float m_alpha;
	...
	public HeatSimulation(List<Vertex> points, float deltaX, int fourierN, float alpha, float L) {
		m_points = points;
		m_fourierN = fourierN;
		m_L = L;
		m_deltaX = deltaX;
	 ...
	 */
	@Override
	public GraphHeat setupSimulation() {
		if (m_points.isEmpty())
		...
		GraphHeat graph = new GraphHeat(fourierCoefficients, m_alpha, m_deltaX, m_L);
