 ...
 */
 ...
 public class Wave implements Equation {

	private double deltaTime;

	public void setupWaveEquation(List<Vertex> points, float deltaX, int fourierTerms, float beta, float L,
	int SCREENWIDTH, int SCREENHEIGHT, int SCALE, int PADDINGX, int PADDINGY) {
	
		deltaTime = deltaX;

		// Simulation setup
		Simulation simulation = new WaveSimulation(points, deltaX, fourierTerms, beta, L);
