...
public class WaveSimulation implements Simulation {
	...
	public WaveSimulation(List<Vertex> points, float deltaX, int fourierN, float beta, float L) {
		m_points = points;
		m_fourierN = fourierN;
		m_L = L;
		m_deltaX = deltaX;
	...
	public Graph setupSimulation() {
		...
		//coefficients found			
		//creating new graph
		Graph graph = new GraphWave(fourierCoefficients, m_beta, m_deltaX, m_L);
